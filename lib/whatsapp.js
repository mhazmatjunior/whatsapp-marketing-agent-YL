...
export const connectWhatsApp = async (sessionId) => {
    ...
    if (!session) {
        session = {
            ...
            status: 'disconnected',
            promise: null,
            // Persistent in-memory store — survives reconnects, accumulates contacts
    ...
    session.promise = (async () => {
        try {
            ...
            // Bind the persistent store to every new socket
            // This tracks contacts, chats, messages across reconnects
